...
public class OutStatsPOStQualification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_stats_post_qualification);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OutStatsPOStQualification.this, StudentHomePage.class);
